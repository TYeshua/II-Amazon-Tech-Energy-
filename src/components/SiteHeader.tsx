...
const links = [['Sobre o evento','#sobre'],['Programação','#programacao'],['Organização','#organizacao'],['Edição anterior','#amazon-2025'],['Inscrição','#inscricao']]
...
export function SiteHeader(){
  ...
  return <header className="site-header">
    ...
    <a className="register" href="#inscricao">Inscrição</a>
